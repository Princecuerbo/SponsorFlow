...
@section('content')
    <div class="admin-login-wrapper">
        <div class="admin-login-card text-center">
            ...
            <!-- Admin Badge -->
            <div class="mb-3">
                <span class="badge rounded-pill text-uppercase" style="background-color: #e0f2fe; color: #0284c7; font-size: 0.65rem; font-weight: 700; letter-spacing: 0.08em; padding: 0.35rem 0.85rem;">
                    ADMIN PORTAL
                </span>
            </div>
            ...
            <!-- Admin Form -->
            <form method="POST" action="{{ route('admin.login.store') }}" class="text-start">
                @csrf
                ...
                <div class="mb-3">
                    ...
                    <div class="input-group">
                        ...
                        <input type="email" id="email" name="email" class="form-control bg-light border-start-0" value="{{ old('email') }}" placeholder="admin@dorsu.edu.ph" required autofocus style="font-size: 0.875rem; height: 42px;">
                    </div>
                </div>
                ...
                <div class="mb-4">
                    ...
                    <div class="input-group">
                        ...
                        <button type="button" onclick="togglePasswordVisibility('password', this)"
                            class="input-group-text bg-light border-start-0 text-gray-400" style="cursor: pointer;"
                ...
                <div class="text-center">
                    <a href="{{ route('login') }}" class="small text-decoration-none text-secondary fw-medium" style="font-size: 0.8rem;">
