...
@section('content')
    <div class="container-fluid p-0 min-vh-100">
        <div class="row g-0 auth-register-wrap">
            ...
            <div class="col-lg-6 d-flex align-items-center justify-content-center px-0 px-md-5 py-5 overflow-y-auto"
                ...
                <div class="w-100 px-3 px-sm-4 py-4" style="max-width: 560px;">
                    ...
                    <form method="POST" action="{{ route('register.store') }}">
                            ...
                            <div class="row g-2.5 mb-3">
                                <div class="col-md-6">
                                    ...
                                    <input type="text" id="barangay" name="barangay"
                                        class="form-control form-control-md bg-light border-1"
                                        value="{{ old('barangay') }}" placeholder="Barangay Name" required
                                        style="font-size: 0.875rem; border-radius: 8px;">
                                </div>
                                <div class="col-md-6">
                                    ...
                                    <input type="text" id="address" name="address"
                                        class="form-control form-control-md bg-light border-1"
                                        value="{{ old('address') }}" placeholder="Street / Purok" required
                                        style="font-size: 0.875rem; border-radius: 8px;">
                                </div>
                            </div>
                        ...
                        <!-- Updated Button with Custom Grey/Black Styling & Hover Effect -->
                        <button type="submit"
